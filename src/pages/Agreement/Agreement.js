        ...
        >
          <div className={classes.content}>
            ...
            <Typography paragraph className={classes.item}>
              ...
              <br/>
              1.3本协议内容同时包括《星狗隐私政策》（链接地址：https://ixingo.com.cn/privacy),且您在使用星狗某一特定服务时，该服务可能会另有单独的协议、相关业务规则等（以下统称为“单独协议”）。上述内容一经正式发布，即为本协议不可分割的组成部分，您同样应当遵守。您对前述任何单独协议的接受，即视为您对本协议全部的接受。您对本协议的接受，即视为您对《星狗隐私政策》的接受。
              <br/>
            </Typography>
            ...
            <Typography paragraph className={classes.item}>
              3.1保护用户个人信息是星狗的一项基本原则。星狗将按照本协议及《星狗隐私政策》（链接地址：https://ixingo.com.cn/privacy）的规定收集、使用、储存和分享您的个人信息。本协议对个人信息保护相关内容未作明确规定的，均应以《星狗隐私政策》的内容为准。
              <br/>
