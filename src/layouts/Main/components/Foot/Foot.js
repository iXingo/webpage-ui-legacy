    ...
    <div {...rest} className={clsx(classes.root, className)}>
      <div className={classes.footCopyright}>
        <Typography variant="body1" className={classes.footer}>
          <a href={"https://www.ixingo.com.cn/about"}
             style={{color: 'white', textDecoration: 'underline'}}>关于星狗</a> |&nbsp;
          <a href={"https://www.ixingo.com.cn/about"} style={{color: 'white', textDecoration: 'underline'}}>About
            Xindog</a> |&nbsp;
          <a href={"https://www.ixingo.com.cn/user-agreement"}
             style={{color: 'white', textDecoration: 'underline'}}>服务协议</a> |&nbsp;
          <a href={"https://www.ixingo.com.cn/privacy"}
             style={{color: 'white', textDecoration: 'underline'}}>隐私政策</a> |&nbsp;
          <a href={"https://www.ixingo.com.cn/copyright"}
