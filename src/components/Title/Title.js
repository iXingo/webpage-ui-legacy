  ...
  return (
    <Grid container className={classes.main}>
      <Grid item xs={12} md={8}>
        ...
        <Typography overline gutterBottom variant='h5' style={{padding: '30px 0', fontWeight: 300}} color="textSecondary">
      ...
      <Grid item md={4}>
        <img alt="Cover" className={classes.mainImg} src="https://developers.google.cn/china/images/skyline_microsite_480.png" />
      </Grid>
    </Grid>
  );
}
