    ...
    <React.Fragment>
      <Grid container className={classes.main}>
        <Grid item xs={12} md={12} className={classes.center} space={3}>
          <Typography gutterBottom variant='h4' style={{padding: '10px 0', color: 'white'}}>
            愿你行走半生，归来仍是少年。
          </Typography>
          <Typography gutterBottom variant='h6' style={{color: '#8EB2F4'}}>
        ...
        <Grid item xs={12} md={3} className={classes.profile} space={3}>
          ...
          <Typography gutterBottom variant='h6' style={{padding: '10px 0', color: '#8EB2F4'}}>
            热爱祖国，拥护党的领导。
          </Typography>
          <Typography gutterBottom variant='h4' style={{padding: '10px 0', color: 'white'}}>
            程序员
